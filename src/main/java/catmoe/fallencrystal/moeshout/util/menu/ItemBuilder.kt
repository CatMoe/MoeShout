...
class ItemBuilder(material: ItemType?) {
    ...
    private val enchantments: MutableList<GUIEnchant> = ArrayList()
    ...
    fun enchantment(enchantment: GUIEnchant): ItemBuilder {
        enchantments.add(enchantment)
        return this
    }

    fun enchantments(enchantments: Array<GUIEnchant>): ItemBuilder {
    ...
    fun enchantment(enchantment: GUIEnchantsList?, level: Int): ItemBuilder {
        enchantments.add(GUIEnchant(enchantment!!, level))
        return this
    }

    fun clearEnchantment(enchantments: GUIEnchantsList): ItemBuilder {
        val temp: List<GUIEnchant> = ArrayList(this.enchantments)
        temp.forEach(Consumer { en: GUIEnchant -> if (en.enchantment === enchantments) this.enchantments.remove(en) })
        return this
    }
    ...
    fun getEnchantments(): List<GUIEnchant> {
        return enchantments
    }
    ...
    private fun replaceFormat(text: String): String {
    ...
    companion object {
        fun of(builder: ItemBuilder): ItemBuilder {
            ...
            return ItemBuilder(item.itemType())
                ...
                .enchantments(builder.enchantments.toTypedArray<GUIEnchant>())
